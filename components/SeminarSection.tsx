...
const SeminarSection: React.FC = () => {
  return (
    <div className="flex flex-col justify-center items-center w-screen md:flex-row py-10 px-10 md:px-24 gap-10 ">
      ...
      <div className=" md:w-1/2 flex flex-col justify-center items-center md:items-start gap-4 text-black">
        ...
        <button className="bg-primary hover:bg-[#c74d4d] hover:scale-110 text-white p-2 w-1/2 rounded-xl mt-3 transition-all duration-300 shadow-xl">
          VIEW DETAILS
        </button>
      </div>
    </div>
