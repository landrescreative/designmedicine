...
import InfoLuchas from '@/components/InfoLuchas';
  ...
  return (
    <div className="flex flex-col items-center ">
          ...
          <div className="flex gap-10 flex-col md:flex-row w-full my-5">
            <div className=" relative rounded-2xl overflow-hidden shadow-lg max-h-96">
              <Image
                ...
                src="/Mexican-Street-Tacos-TIMG.jpg"
                alt="Image 1"
                width={500}
                height={500}
              />
            ...
            <div className=" relative rounded-2xl overflow-hidden shadow-lg max-h-96">
              <Image
                className="w-full h-full object-cover"
                src="/Lucha-libre-México-CMLL.webp"
                alt="Image 2"
                width={500}
                height={500}
              />
      ...
      <div className="atracciones flex flex-col flex-wrap justify-center items-center my-10 gap-10 w-full">
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3762.726850301741!2d-99.153122925413!3d19.42016144380013!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1ff405f77fe8d%3A0x913d92b71e1747b4!2sArena%20M%C3%A9xico!5e0!3m2!1ses-419!2smx!4v1723970226563!5m2!1ses-419!2smx"
          width="600"
          height="450"
          loading="lazy"
          style={{
