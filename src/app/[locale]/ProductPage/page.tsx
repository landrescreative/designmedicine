...
<div className="flex flex-col items-center md:items-start text-center md:text-left flex-grow">
  ...
  <div className="flex items-end bg-[#FBF3EA] p-1 rounded-3xl" style={{ width: '60px' }}> {/* Ancho fijo */}
    <span className="text-[#e0c8a2]" style={{ fontSize: '18px' }}>☆</span>
    <span className="ml-1 text-gray-600 text-sm">4.8</span>
  </div>

  {/* Óvalo para reseñas */}
  <div className="flex items-center bg-[#EDF0F8] p-1.5 rounded-full" style={{ width: '130px' }}> {/* Ancho fijo */}
    <svg
